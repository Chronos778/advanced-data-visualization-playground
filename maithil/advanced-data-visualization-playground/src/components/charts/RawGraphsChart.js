...
const chartMap = {
  alluvialdiagram,
  arcdiagram,
  barchart: barchart, // Note: This might conflict with existing bar chart
  barchartmultiset,
  barchartstacked,
  beeswarm,
  boxplot,
  bubblechart: bubblechart, // Note: This might conflict with existing bubble chart
  bumpchart,
  calendarHeatmap,
  chorddiagram,
  circlepacking,
  circularDendrogram,
  contourPlot: contourPlot, // Note: This might conflict with existing contour
  convexHull,
  dendrogram,
  ganttChart,
  hexagonalBinning,
  horizongraph,
  linechart: linechart, // Note: This might conflict with existing line chart
  matrixplot,
  parallelcoordinates,
  piechart: piechart, // Note: This might conflict with existing pie chart
  radarchart,
  sankeydiagram,
  slopechart,
  streamgraph,
